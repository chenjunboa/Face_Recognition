...
# from recognize_s import recognize
from facerecognition import FaceRecognitionSystem
from login import lojin
class UserMainUi(object):
    def setupUi(self, MainWindow):
        ...
        # self.camera_button.clicked.connect(self.clickButton)
        ...
        # self.login_button.clicked.connect(exec())
        # self.login_button.clicked.connect(lojin)
        self.login_button.clicked.connect(clicked_1)
        # self.login_button.clicked.connect(lojin)


        # self.login_button.clicked.connect(exit(MainWindow))
        # self.login_button.clicked.connect(lojin)
        ...
        # self.recognition_button.clicked.connect(recognize)
        ...
        MainWindow.setWindowIcon(QIcon('chushi.gif'))  # 设置logo
...
def recognize(self):
    system = FaceRecognitionSystem(model_path='20170512-110547.pb',
                                   id_folder='ids',
                                   threshold=2,
...
if __name__ == '__main__':
    ...
    widgets2= QtWidgets.QMainWindow()
    ui2= UserMainUi()
    ui2.create(widgets2)
